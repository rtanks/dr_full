...
export default function Notification({text, show='', change, bg1, bg2}) {
    ...
    return (
        <motion.div animate={{translateY: [0,1],transition:{duration: 0.5}}} className={`w-[90%] sm:w-80 text-white text-sm flex flex-col gap-1 fixed left-5 top-5 ${bg1} overflow-hidden rounded-lg z-50`}>
