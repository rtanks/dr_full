...
import VisitDoctorRequestHospital from "./VisitDoctorRequestHospital";
...
export default function RequestDoctor({data}) {
    ...
    console.log(data)
    // const audioSelector = [{id: "audio", text: "نیاز دارم"},{id: "withoutAudio", text: "نیاز ندارم"}]
    return (
        <div className="w-full h-full overflow-y-scroll">  
            <VisitDoctorRequestHospital userInfo={userInfo} requestData={data}/>
        </div>
    )
}
            ...
            //                         <div key={item.id} className={`w-full h-max flex flex-row gap-2 sm:gap-3 
