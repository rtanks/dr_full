...
const SetCities = ({ setData, data, province, alert, style, disabled = false }) => {
  ...
  return (
    <>
      ...
      <div
        ...
        } relative flex h-12 ${style} items-center justify-between rounded-[10px] border border-gray-300 bg-gray-100 px-5 !text-black outline-gray-300 dark:bg-white`}
      >
        {city ? (
          <p className={`line-clamp-1 !text-black`}>{city}</p>
        ) : (
          <p
                ...
                <div
                  ...
                  className={`block px-4 py-2 text-right
                   hover:bg-gray-100 dark:hover:bg-gray-600
                    ...
                    ${i.name == city? "bg-gray-600 text-white": "bg-gray-100 text-black" }
                    `}
                  key={index}
                >
                  {i.name}
