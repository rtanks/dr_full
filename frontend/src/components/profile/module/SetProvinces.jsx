  ...
  return (
    <>
      ...
      <div
        ...
        } bg-wite relative flex h-12 ${style} items-center justify-between rounded-[10px] border border-gray-300 px-5 !text-black outline-gray-300 bg-gray-100 dark:bg-white 
        `}
      >
        {province ? (
            ...
            >
              {provinces.map((i, index) => (
                <div
                  ...
                  className={`block px-4 py-2 text-right hover:bg-gray-100 
                  dark:hover:bg-gray-600 dark:hover:text-white
                  ${i.name == province? "bg-gray-600 text-white": "bg-gray-100 text-black" }
                  `}
                  key={index}
                  // value={i.id}
                >
