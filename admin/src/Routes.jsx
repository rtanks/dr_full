...
import Informing from "./pages/Informing";
import InformingAuto from "./pages/InformingAuto";
      ...
      <Routes>
        <Route path="/">
          ...
          <Route element={<Dashboard/>}>
            ...
            <Route path="/dashboard/informing" element={<Informing/>}/>
            <Route path="/dashboard/informingauto" element={<InformingAuto/>}/>
          </Route>
        </Route>
