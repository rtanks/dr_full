...
export default function SelectPartBody({getAreas, register, containerRef}) {
    ...
    const scrollToAreaSelected = () => {
        ...
        const offset = target.offsetTop + target.offsetHeight * 0.01
        console.log(offset)
    ...
    return (
        <div {...register} tabIndex={-1} ref={parentElement} className="w-full h-max flex flex-col gap-2">
            <div className="w-full h-max flex flex-col gap-5 mt-4 px-1 sm:mt-5">
                <div className="w-full h-max flex flex-col gap-5 items-center">
                ...
                <div className="w-full h-[51vh] sm:h-[65vh] flex flex-row">
                    <div className="w-[45%] sm:w-[50%] pt-3">
                        {
                            itemsArea.length == 0 ? (
                    ...
                    <div className="w-[55%] sm:w-[60%] h-full">
                        {showSide()}
                    </div>
                </div>
            </div>
