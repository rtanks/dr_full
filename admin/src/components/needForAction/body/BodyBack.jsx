...
export default function BodyBack({pic, getItemsArea, scrollToSelectBox}) {
    const [position, setPosition] = useState({top: null, right: null});
    const back = { 
        'head_back': { options: ['پس سر', 'پشت گردن',, 'ستون فقرات گردنی'], position: { top: '4', right: '43' } },
        'neck_back': { options: ['پشت گردن', 'ستون فقرات گردنی', 'پس سر'], position: { top: '12', right: '43' } },
        'upper_back_center': { options: ['بین دو کتف', 'ستون فقرات (بالا)', 'کتف راست', 'کتف چپ'], position: { top: '20', right: '43' } },
        'shoulder_back_right': { options: ['کتف راست', 'شانه راست', 'پشت بازو راست'], position: { top: '20', right: '23' } }, 
        'shoulder_back_left': { options: ['کتف چپ', 'شانه چپ', 'پشت بازو چپ'], position: { top: '20', right: '61' } }, 
        ...
        'lower_back_center': { options: ['پایین کمر', 'ستون فقرات (مرکز)','باسن راست', 'باسن چپ'], position: { top: '41', right: '43' } },
