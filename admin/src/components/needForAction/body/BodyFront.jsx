...
export default function BodyFront({pic,getItemsArea, scrollToSelectBox}) {
    const [position, setPosition] = useState({top: null, right: null});
    const front= { 
        'head': { options: ['سر', 'صورت', 'فک', 'گردن'], position: { top: '5', right: '43' } }, 
        'neck': { options: ['گردن', 'سر', 'صورت', 'فک', 'ترقوه'], position: { top: '14', right: '43' } }, 
        'sternum_upper': { options: ['استخوان جناغ', 'مرکز سینه', 'ترقوه'], position: { top: '21', right: '43' } },
        'shoulder_right': { options: ['شانه راست', 'بازو راست', 'ترقوه'], position: { top: '19', right: '62' } }, 
        'shoulder_left': { options: ['شانه چپ', 'بازو چپ', 'ترقوه'], position: { top: '19', right: '23' } }, 
        ...
        'knee_right': { options: ['زانو راست', 'ساق راست','مچ پای راست'], position: { top: '75', right: '58' } }, 
        'knee_left': { options: ['زانو چپ', 'ساق چپ','مچ پای چپ'], position: { top: '75', right: '26' } }, 
